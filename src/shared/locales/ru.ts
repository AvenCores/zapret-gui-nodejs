export const ru = {
  ...
  'updates.hostsLocal': 'Системный Hosts',
  'updates.hostsUpstream': 'Апстрим',
  ...
  'updates.removeHosts': 'Удалить из системного Hosts',
  'updates.hostsRemoved': 'Zapret-записи удалены из системного Hosts (бэкап: hosts.zapret-gui.bak).',
  'updates.hostsRemoveNothing': 'В системном Hosts нет zapret-записей — удалять нечего.',
  'updates.removeHostsConfirm': 'Удалить zapret-записи из системного Hosts?',
  ...
  'diag.configTests': 'Тесты стратегий',
  'diag.modeStandard': 'Стандартные (HTTP/ping)',
  'diag.modeDpi': 'DPI (TCP 16–20)',
  'diag.selectConfigs': 'Стратегии для теста',
  'diag.selectAll': 'Все',
  'diag.selectNone': 'Снять',
  'diag.searchConfigs': 'Поиск…',
  'diag.startTests': 'Запустить тесты',
  'diag.stopTests': 'Остановить',
  'diag.testingProgress': '{done}/{total} — {current}',
  'diag.bestConfig': 'Лучшая: {name}',
  'diag.applyBest': 'Применить лучшую',
  'diag.noTestResults': 'Пока нет результатов — выберите стратегии и запустите тесты.',
  'diag.requiresAdmin': 'Нужны права администратора',
  ...
  'tool.cacheNoAppData': 'Пропуск очистки кэша Discord: APPDATA недоступна',
  'tool.cacheClosed': '{dir}: процесс завершён',
  'tool.cacheCleared': '{dir}/{sub}: очищено',
  'tool.cacheFailed': '{dir}/{sub}: ОШИБКА ({error})',
  'tool.cacheNotFound': 'Установки Discord не найдены',
  'tool.conflictRemoving': 'Удаление конфликтующего сервиса: {name}',
  'tool.conflictRemovingDriver': 'Удаление {name}…',
  'tool.conflictsRemoved': 'Удалено: {list}',
  'tool.conflictsNone': 'Конфликтующие сервисы не найдены',
  ...
  'diag.detail.stuckFound': 'winws не запущен, а WinDivert активен — зависшая служба, удалите её через Инструменты',
  'diag.detail.timeout': 'Проверка не уложилась в таймаут',
  ...
  'logs.all': 'Все',
  'logs.zapret': 'Zapret',
  'logs.tgproxy': 'TG-прокси',
  'logs.app': 'Программа',
  'logs.disabled': 'Логи отключены в настройках — включите их, чтобы видеть новые записи.',
  'settings.logsTitle': 'Логи',
  'settings.logsEnabled': 'Вести логи',
  'settings.logsHint': 'Когда выключено, приложение не пишет файлы логов и не передаёт их в интерфейс — меньше нагрузка на ЦП и диск в фоне.',
  ...
  'lists.title': 'Пользовательские списки',
  'lists.hint': 'Файлы *-user.txt из папки data/lists. Exclude-списки исключают домены/IP из обхода, general-список добавляет домены в обход.',
  'lists.addPlaceholder': 'Добавить домен или IP…',
  'lists.add': 'Добавить',
  'lists.saved': 'Сохранено',
  'lists.entries': '{count} записей',
  'lists.empty': 'Файл пуст — добавьте записи выше или вставьте список.',
  'lists.neverEmpty': 'Этот файл нельзя оставлять пустым: winws требует хотя бы одну строку.',
  ...
  'settings.trayServiceMenu': 'Управление сервисом (Запустить / Остановить / Перезапустить)',
  'settings.trayNavigateMenu': 'Подменю «Открыть раздел»',
  'settings.trayGameFilterMenu': 'Подменю «Game Filter»',
  'settings.trayIPSetMenu': 'Подменю «IPSet Filter»',
  'settings.trayToolsMenu': 'Инструменты (папка данных, экспорт логов)',
  ...
  'settings.resetTitle': 'Сброс приложения',
  'settings.resetDesc': 'Полный сброс: настройки вернутся к значениям по умолчанию, папка данных (стратегии, списки, движок, бэкапы, результаты тестов), логи и сервисы zapret будут удалены и созданы заново. Системный Hosts не затрагивается. Действие необратимо.',
  'settings.resetButton': 'Сбросить всё',
  'settings.resetBusy': 'Сброс…',
  'settings.resetConfirm': 'Точно выполнить полный сброс? Настройки, данные, импортированные стратегии и сервисы zapret будут удалены.',
  'settings.resetDone': 'Настройки и данные сброшены к значениям по умолчанию.',
  'settings.resetNoAdmin': 'Настройки и данные сброшены, но сервисы не удалены — перезапустите приложение с правами администратора и повторите сброс.',
  'settings.resetBlocked': 'Сначала остановите zapret (Дашборд → Остановить): запущенный сервис блокирует файлы данных.',
  'tgProxy.title': 'Telegram-прокси',
  'tgProxy.desc': 'Встроенный MTProto-прокси: Telegram Desktop подключается к 127.0.0.1, а трафик идёт через WebSocket к серверам Telegram.',
  'tgProxy.statusRunning': 'Запущен',
  'tgProxy.statusStopped': 'Остановлен',
  'tgProxy.statusError': 'Ошибка',
  'tgProxy.port': 'Порт',
  'tgProxy.autoStart': 'Запускать TG-прокси вместе с приложением',
  'tgProxy.cfFallback': 'CF-прокси fallback',
  'tgProxy.connections': 'Активные соединения',
  'tgProxy.traffic': 'Трафик',
  'tgProxy.link': 'Ссылка для Telegram',
  'tgProxy.copyLink': 'Скопировать ссылку',
  'tgProxy.openLink': 'Открыть в Telegram',
  'tgProxy.linkCopied': 'Ссылка скопирована!',
  'tgProxy.restartHint': 'Смена порта применится после перезапуска прокси.',
  'tgProxy.host': 'Адрес прослушивания',
  'tgProxy.dcIps': 'IP дата-центров',
  'tgProxy.poolSize': 'Размер пула WS',
  'tgProxy.bufferKb': 'Буфер сокета (КБ)',
  'tgProxy.cfDomains': 'Свои CF-домены',
  'tgProxy.workerDomains': 'CF Worker-домены',
  'tgProxy.fakeTlsDomain': 'FakeTLS-домен',
  'tgProxy.forceTestDc': 'Только тестовые DC',
  'tgProxy.proxyProtocol': 'PROXY-протокол',
  'tgProxy.resetSettings': 'Сбросить настройки',
  'tgProxy.resetConfirm': 'Сбросить настройки TG-прокси к значениям по умолчанию? (Секрет и запущенное состояние сохранятся.)',
  'tray.tgProxy': 'TG-прокси',
} as const