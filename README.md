...
| Обновления | Проверка версии zapret-данных, обновление IPSet-списка, обновление стратегий из release-ZIP с GitHub (с бэкапом `data/_backup/<timestamp>`), автообновление самого приложения |
